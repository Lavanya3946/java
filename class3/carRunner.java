class Car
 {
     ...
     Car(String make, String model, int year)
	{
     ...
     Car(String make, String model, int year, String engineType, String transmission)
	{
        this.make = make;
        this.model = model;
        this.year = year;
     ...
     Car(String make, String model, int year, String color, String engineType, int horsepower, int torque, String transmission, int numberOfDoors, boolean isElectric)
	{
        this.make = make;
        this.model = model;
        this.year = year;
